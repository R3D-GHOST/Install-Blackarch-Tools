...
echo "Hola este script te ayudara a instalar las herramientas de blackarch sin errores"
sleep 2
clear
#banner del creador r3dgh0st instagram:@ethical_hacking_redghost
echo "
    _    ____   ____ _   _   _   _    _    ____ _  _____ _   _  ____ 
   / \  |  _ \ / ___| | | | | | | |  / \  / ___| |/ /_ _| \ | |/ ___|
  / _ \ | |_) | |   | |_| | | |_| | / _ \| |   | ' / | ||  \| | |  _ 
 / ___ \|  _ <| |___|  _  | |  _  |/ ___ \ |___| . \ | || |\  | |_| |
/_/   \_\_| \_\\____|_| |_| |_| |_/_/   \_\____|_|\_\___|_| \_|\____|
                                                                     
 _____ ___   ___  _     ____  
|_   _/ _ \ / _ \| |   / ___| 
  | || | | | | | | |   \___ \ 
  | || |_| | |_| | |___ ___) | (By R3D-GHOST)
...
echo "[1] Añadir Blackarch (Necesario) "
echo "[2] Instalar Tools de blackarch "
echo "[3] EXIT"

read -p "Elige una Opcion ->> " i
